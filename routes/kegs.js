...
router.get('/:id/qrcode.png', async (req, res) => {
  try {
    ...
    // This URL gets embedded in the actual printed QR code on the
    // physical keg - the single most consequential place any file
    // rename needs to reach, since every real-world scan of a real
    // keg goes through whatever this generates, regardless of any
    // other web-navigation fix.
