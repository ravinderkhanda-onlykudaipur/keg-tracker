...
const TRANSITIONS = {
  ...
  receive_from_driver: { role: 'warehouse', from: ['empty_at_customer'],                 to: 'received_from_driver' },
  ...
  // allot_washer, allot_filler, assign_destination, receive_from_driver,
  // receive_empty, or mark_repaired, each of which captures something
  // real, not as a free-floating log entry.
};
