...
const STATUS_TO_V2 = {
  ...
  allotted_washer:       { current_location: 'mover',     current_condition: 'empty',  pending_handover_to: 'washer', pending_handover_transition_id: 'mover_to_washer' },
  received_washer:       { current_location: 'washer',    current_condition: 'empty' },
  washed:                { current_location: 'washer',    current_condition: 'cleaned', pending_handover_to: 'filler', pending_handover_transition_id: 'washer_to_filler_direct' },
  clean_storage:         { current_location: 'washer',    current_condition: 'cleaned', pending_handover_to: 'mover', pending_handover_transition_id: 'washer_to_mover_cleaned' },
  ...
  filled:                { current_location: 'filler',    current_condition: 'filled', pending_handover_to: 'mover', pending_handover_transition_id: 'filler_to_mover' },
  received_from_filler:  { current_location: 'mover',     current_condition: 'filled' },
  dispatched:            { current_location: 'mover',     current_condition: 'filled', pending_handover_to: 'driver', pending_handover_transition_id: 'mover_to_driver_dispatch' },
  ...
  returned_to_warehouse: { current_location: 'driver',    current_condition: 'empty',  pending_handover_to: 'mover', pending_handover_transition_id: 'driver_to_mover_empty' },
